...
def main():
    ...
    parser.add_argument('--datafolder', '-d', help='Path to input *_pred.h5', default='../../data/semantic3d/raw/test_reduced/')
    parser.add_argument('--version', '-v', help='full or reduced', type=str, default='reduced')
