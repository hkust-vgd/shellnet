...
def main():
    ...
    parser.add_argument('--load_ckpt', '-l', default='log/seg/shellconv_seg_scannet_xxxx/ckpts/epoch-31', help='Path to a check point file for load')
    parser.add_argument('--model', '-m', default='shellconv', help='Model to use')
    parser.add_argument('--setting', '-x', default='seg_scannet', help='Setting to use')
    parser.add_argument('--repeat_num', '-r', help='Repeat number', type=int, default=1) # 1 is good enough
